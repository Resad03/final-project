...
const Header = () => {
    ...
    return (
        ...
        <Container>
          <Link to="/">
            <Navbar.Brand className={darkMode? 'text-dark-primary': 'text-light-primary'} style={{fontSize: '30px'}}>
                <b>Min bir xırdavat</b>
            </Navbar.Brand>
          </Link>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              >
                ...
                <span style={{ marginLeft: !isEmpty ? '-13px': 0}}>&nbsp;Səbət</span>
              </Link>
