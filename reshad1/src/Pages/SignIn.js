                ...
                <Col xs={11} sm={10} md={8} lg={4} className={`p-4 rounded ${theme? 'text-light bg-dark' : 'text-black bg-light'}`}>
                    ...
                    <Form onSubmit={handleSubmit}>
                        <InputGroup className="mb-4 mt-5">
                            ...
                            <Form.Control name="username" type="text" placeholder="İstifadəçi adı" minLength={3} required />
                        </InputGroup>
                        <InputGroup className="mb-4">
                            <InputGroup.Text>
                                <VscKey size="1.8rem" />
                            </InputGroup.Text>
                            <Form.Control name="password" type="password" placeholder="Parol" minLength={6} required />
                        </InputGroup>
                        <Button
                            type="submit"
