                     ...
                     <Col sm={8} className={`${theme? 'text-light bg-dark' : 'text-black bg-light'} p-2 rounded`}>
                        <Tab.Content>
                            <Tab.Pane eventKey="my-orders">
                                <Heading heading="Sifarişlərim" size="h3" />
                                <OrderCard 
                                    orderDate="15 dekabr, 2022" 
                                    orderId="1234" 
                                    title="Fjallraven - Foldsack No. 1 Backpack, Fits 15 Laptops"
                                    img="https://fakestoreapi.com/img/81fPKd-2AYL._AC_SL1500_.jpg"
                                    deliveredDate="22 dekabr , 2022"
                                />
                                <OrderCard 
                                    orderDate="16 dekabr, 2022" 
                                    orderId="1334" 
                                    title="Mens Casual Premium Slim Fit T-Shirts"
                                    img="https://fakestoreapi.com/img/71-3HjGNDUL._AC_SY879._SX._UX._SY._UY_.jpg"
                                    deliveredDate="23 dekabr, 2022"
                                />
                            </Tab.Pane>
                            <Tab.Pane eventKey="account-details">
                                <Heading heading="Hesab məlumatları" size="h3" />
                            </Tab.Pane>
                            <Tab.Pane eventKey="address">
                                <Heading heading="Adres" size="h3" />
                            </Tab.Pane>
                            <Tab.Pane eventKey="wallet">
                                <Heading heading="Pulqabı" size="h3" />
                            </Tab.Pane>
                        </Tab.Content>
                     </Col>
                </Row>
